...
def fetch_venue_data():
    """
    address = {重庆大学-虎溪校区游泳馆, 重庆大学-虎溪校区篮球馆, 重庆大学-虎溪校区羽毛球馆, 重庆大学-虎溪校区健身馆}
    :return:
    """
    # 请求的URL
    ...
    # 初始化一个字典来存储每个场馆的信息，场馆名称作为键
    venues_info = {}

    # 检查响应数据中的'success'字段，确保请求成功
    if data['success']:
...
def create_ticket_order(token, ticket_info, use_date):
    ...
    :param ticket_info: 包含各时间段票种信息的字典
